  ...
  return (
    <div className=" pb-3 bg-primary  text-white mb-10 text-center overflow-hidden hover:shadow-lg transition-shadow">
      <img
        src={speaker.image}
        alt={speaker.name}
        className="w-full h-44 object-top object-cover filter "
...
export default function EventDetail() {
  ...
  return (
    ...
    >
        ...
        <div className="container mx-auto px-4">
          <div className="">
            {programSchedule.map((daySchedule, index) => (
              <div
                key={index}
                className="bg-white shadow-md flex-row justify-start  p-6 border-l-4 border-primary"
              >
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <div>
                    ...
                    {[
                      ...
                      <div key={index} className="flex text-gray-700 py-2 text-sm items-center space-x-2">
                        <input
                          type="checkbox"
                  ...
                  <button
                    type="submit"
                    className="w-full border border-primary text-primary hover:bg-primary hover:text-white ease-in duration-200  p-3 rounded"
                  >
                    Submit Registration
                  </button>
                </form>
      ...
      {/* <section className="bg-gradient-to-r from-green-400 to-primary flex items-center text-white py-20 text-center px-52">
